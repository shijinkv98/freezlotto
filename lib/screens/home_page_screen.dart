...
class _NewsFeedScreenState extends State<HomePageScreen>{
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return  Container(
                      ...
                      child:
                      homeBloc.advertisementList[index].fileType == "image"?
                      Container(margin:EdgeInsets.only(bottom:50,top: 40,left: 30,right: 30),
                        height: MediaQuery.of(context).size.height,
                        width: MediaQuery.of(context).size.width,
                        ...
                        child:ClipRRect(
                         borderRadius: BorderRadius.all(Radius.circular(31)),
                          child: FadeInImage.assetNetwork(
                            ...
                            image: '${APIClient.Ad_Asset_Location}${homeBloc.advertisementList[index].advertisement}',
                          ),
                        ),
                      )
                            :      Container(
                                            ...
                                            InkWell(
                                              ...
                                              child: Align(
                                                ...
                                                child: Container(margin:EdgeInsets.only(right: 0),height: 45,width:45,
                                                    ...
                                                    child: Icon(_controller.value.isPlaying ?Icons.pause_circle_filled_outlined : Icons.play_circle_filled_outlined,color: white,size: 55,)
                                                ),
                                              ),
                                            ),
                                          ], //<Widget>[]
  ...
  // Widget homePageVideo(HomeBloc homeBloc){
  //   return
  //     Container(
  //     color: white,
  //     child: Stack(
    ...
    child: Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            children: [
              Text('OOPS!  NO INTERNET',style: TextStyle(color: textColor,fontSize: 20,fontWeight: FontWeight.bold),),
              SizedBox(height: 5),
              Text('Please check your network connection',style: TextStyle(color: textColor,fontSize: 20),),
            ],
          ),
        ),
        Container(
            ...
            child: FlatButton(onPressed: updateUI,color: textColor,child: Text('Try Again',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold),),))
      ],
    ),
  );
  Widget homePage(){
