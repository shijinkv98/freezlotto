...
final TextStyle style2 = TextStyle(color:settingTitletextColor,fontWeight: FontWeight.w400,fontFamily: MEDIUM_FONT,fontSize: 20,letterSpacing: 0.8);
  ...
  Widget getBody(){
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          children: [
            getContent('assets/images/profile.png', 'Profile'),
          ...
          children: [
            Row(
              ...
              children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.only(right: 10),
                        ...
                        child: Padding(
                          ...
                          child: Image.asset(assetImage,width: 16,height: 16,),
                        )),
                ...
                Icon(Icons.arrow_forward_ios,color: forwardIconColor,size: 15,),
              ],
            ),
            Padding(
