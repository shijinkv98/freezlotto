...
class NewsFeedVideoDynamic extends StatefulWidget {
  ...
  String category;
  @override
  _NewsFeedVideoDynamicState createState() => new _NewsFeedVideoDynamicState(id: this.id);
  NewsFeedVideoDynamic({this.url,this.title,this.category,this.price,this.id});
}

class _NewsFeedVideoDynamicState extends State<NewsFeedVideoDynamic>{
  ...
  _NewsFeedVideoDynamicState({this.id});
  @override
  void initState()  {
              ...
              return Scaffold(
                  ...
                  body:  Consumer<NewsFeedBloc>(
                    builder: (context, newsfeedBloc, child) =>
                        ModalProgressHUD(
                            inAsyncCall: newsfeedBloc.isLoading,
                            child: getLandScape(newsfeedBloc)),
                  ));
  ...
  Widget getLandScape(NewsFeedBloc newsFeedBloc) {
    return
      Container(
      height: MediaQuery
          .of(context)
      ...
      child: Stack(
        children: [
          ...
          Align(
              alignment: Alignment.topCenter,
              child: getLandScapeContainer(newsFeedBloc)
          ),
        ],
      ),
    );
  ...
  Widget getLandScapeContainer(NewsFeedBloc newsFeedBloc) {
    return Container(
